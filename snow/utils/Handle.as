package snow.utils 
{
	...
	public class Handle 
	{
		...
		public static function isClass(object:*, cl:Class):Boolean
		{
			if (object is cl)
			{
				return true
		...
		public static function computMinute(value:Number):String
		{
			var hou_str:String = "";
			var min_str:String = "";
			var hours:Number = Math.floor(value / 60);
			var minute:Number= Math.round(value % 60);
			if (hours >= 10)
			{
				hou_str=String(hours);
			}else
		 ...
		 * @return
		 */
		public static function FindArrayAtValue(target:Array, name:String, value:*):Object
		{
			for (var i:int = 0; i <target.length; i++) 
			{
				if (target[i][name] == value)
				{
		 ...
		 * @return
		 */
		public static function FindArrayAtGroup(target:Array, name:String, value:*):Array
		{
			var arr:Array = [];
			for (var i:int = 0; i <target.length; i++) 
			{
